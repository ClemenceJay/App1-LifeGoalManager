...
const ModaleGenerale = ({ typeModale, setModalVisible, goalModal, deleteGoal, editGoal, setNomGoalToEdit, nomGoalToEdit }) => {
    ...
    return (
        <View style={styles.modal}>
            ...
            {typeModale =='done'? <ModalDone setModalVisible={setModalVisible} goalModal={goalModal}/> : null}
